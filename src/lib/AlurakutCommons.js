  ...
  .container {
    ...
    nav {
      ...
      a {
        ...
        /* &:after {
          content: " ";
          background-color: rgba(0, 0, 0, .5); // Separator
          display: block;
          position: absolute;
          width: 1px;
          height: 12px;
    ...
    input {
      color: #fafafa;
      background: ${props => props.theme.inputMenuColor};
      transition: background .25s;
      padding: 10px 42px;
      border: 0;
...
AlurakutMenu.Logo = styled.img`
  background-color: ${props => props.theme.logoMenuColor};
  padding: 9px 14px;
  border-radius: 1000px;
  height: 34px;
`;
...
OrkutNostalgicIconSet.List = styled.ul`
  ...
  li {
    font-size: 12px;
    color: ${props => props.theme.boxLiColor};
